(function (global, factory) {
  ...
  class HTMLMaskElement extends MaskElement {
    ...
    get rootElement() {
      ...
      return (_this$input$getRootNo =
        (_this$input$getRootNo2 = (_this$input = this.input).getRootNode) == null ? void 0 : _this$input$getRootNo2.call(_this$input)) != null
  ...
  class RepeatBlock extends MaskedPattern {
    ...
    _update(opts) {
      ...
      super._update({
        mask: 'm'.repeat(
          Math.max((this.repeatTo === Infinity && ((_this$_blocks = this._blocks) == null ? void 0 : _this$_blocks.length)) || 0, this.repeatFrom)
        ),
        blocks: {
          m: block,
        },
